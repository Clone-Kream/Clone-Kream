export const notification = [
  {
    name: "delivery",
    title: "배송 기간 안내",
    desc: `KREAM은 최대한 빠르게 모든 상품을 배송하기 위해 노력하고 있습니다. 배송 시간은 판매자가 검수를 위하여 상품을 검수센터로 보내는 속도에 따라 차이가 있습니다.
    [빠른배송 구매]
  ...
  },
  {
    name: "inspectation",
    title: "검수 안내",
    desc: `판매자의 상품이 검수센터에 도착하면 전담 검수팀이 철저한 분석과 검사로 정가품 확인을 진행합니다.
  ...
  },
  {
    ...
    desc: `- 체결 후 15분 이내에 구매 결정 또는 구매 거부를 선택할 수 있습니다. 구매 결정 이후에는 취소/교환/반품이 불가능합니다.
